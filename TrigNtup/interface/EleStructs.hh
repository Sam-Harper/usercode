...
namespace EleStructs {
  ...
  struct GenPUStruct {
   ...
   struct HLTEgammaStruct {
     float et,nrgy,eta,phi,hadem,sigmaIEtaIEta,dEtaIn,dPhiIn,nrMissHits,nrClus,seedClusEFrac,pmDPhi1,pmDPhi2,pmDPhi3,pmDPhi4,pmDPhi1Info,pmDPhi2Info,pmDPhi3Info,pmDPhi4Info,pmDRZ1,pmDRZ2,pmDRZ3,pmDRZ4,pmDRZ1Info,pmDRZ2Info,pmDRZ3Info,pmDRZ4Info,phiWidth,etaWidth;
   
    static std::string contents(){return "et/F:nrgy:eta:phi:hadem:sigmaIEtaIEta:dEtaIn:dPhiIn:nrMissHits:nrClus:seedClusEFrac:pmDPhi1:pmDPhi2:pmDPhi3:pmDPhi4:pmDPhi1Info:pmDPhi2Info:pmDPhi3Info:pmDPhi4Info:pmDRZ1:pmDRZ2:pmDRZ3:pmDRZ4:pmDRZ1Info:pmDRZ2Info:pmDRZ3Info:pmDRZ4Info:phiWidth:etaWidth";}
    void fill(const SHTrigObj& cand,const std::string& tag=""); 
     void clear(){et=nrgy=eta=phi=hadem=sigmaIEtaIEta=dEtaIn=dPhiIn=nrMissHits=nrClus=seedClusEFrac=pmDPhi1=pmDPhi2=pmDPhi3=pmDPhi4=pmDPhi1Info=pmDPhi2Info=pmDPhi3Info=pmDPhi4Info=pmDRZ1=pmDRZ2=pmDRZ3=pmDRZ4=pmDRZ1Info=pmDRZ2Info=pmDRZ3Info=pmDRZ4Info=phiWidth=etaWidth=-999.;}
  };
}
