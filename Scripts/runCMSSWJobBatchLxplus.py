...
def make_cfg(args):
    ...
    cfg['log_dir'] = '{}/{}/{}/logs'.format(cfg['base_logdir'],cfg['cmssw_version'][6:],args.outputDir)
    cfg['in_proxy_file'] = '/tmp/x509up_u27524'
...
def make_job_script_txt(cfg):
    #it is highly important that the shebang is on the first line and there 
    #is not an empty line above it
