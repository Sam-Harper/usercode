...
process.trigCrossSec = cms.EDAnalyzer("TrigCrossSecMaker",           
                                   #trigEventTag = cms.InputTag("hltTriggerSummaryAOD","","HLT"),
                                      trigResultsTag = cms.InputTag("TriggerResults","","HLT3"),
                                   # pathName = cms.string("HLT_Ele30_CaloIdVT_TrkIdT_PFJet100_PFJet25_v6"),
                                      pathName = cms.string("HLT_Ele30_CaloIdVT_TrkIdT_PFJet100_PFJet25_v6"), 
                                     # selectingPathName = cms.string("HLT_Ele27_CaloIdVT_TrkIdT_DiCentralPFJet25_v5"),
                                      selectingPathName =cms.string(""),
                                      outputFilename = cms.string(sys.argv[len(sys.argv)-1]),
                                      lumiDataFilename = cms.string("lumiData_run180250.txt")
                                   )
