# /users/sharper/2015/testing/BasicTestMenu/V2 (CMSSW_7_4_0_pre9)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "TEST" )
process.load("SHarper.TrigTools.hlt_setup_cff")
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/sharper/2015/testing/BasicTestMenu/V2')
)
...
process.hltL1sL1SingleEG40ORL1SingleEG35ORL1DoubleEG2210ORL1DoubleEG1510 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG40 OR L1_SingleEG35 OR L1_DoubleEG_22_10 OR L1_DoubleEG_15_10" ),
...
process.hltEGL1SingleEG40OREG35ORDoubleEG2210ORDoubleEG1510Filter = cms.EDFilter( "HLTEgammaL1MatchFilterRegional",
    ...
    L1SeedFilterTag = cms.InputTag( "hltL1sL1SingleEG40ORL1SingleEG35ORL1DoubleEG2210ORL1DoubleEG1510" ),
...
process.hltEG33EtFilter = cms.EDFilter( "HLTEgammaEtFilter",
    ...
    inputTag = cms.InputTag( "hltEGL1SingleEG40OREG35ORDoubleEG2210ORDoubleEG1510Filter" ),
...
##process.HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_MW_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleEG40ORL1SingleEG35ORL1DoubleEG2210ORL1DoubleEG1510 + process.hltPreDoubleEle33CaloIdLGsfTrkIdVLMW + process.HLTEle33CaloIdLGsfTrkIdVLMWSequence + process.HLTDoubleEle33CaloIdLGsfTrkIdVLMWUnseededSequence + process.HLTEndSequence )
...
##process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_MW_v1, process.HLTriggerFinalPath ))
...
process.hltRechitInRegionsECALESStd = cms.EDProducer("HLTEcalRecHitInAllL1RegionsProducer",
                                                recHitLabels = cms.VInputTag( 'hltEcalRecHit:EcalRecHitsEB','hltEcalRecHit:EcalRecHitsEE','hltEcalPreshowerRecHit:EcalRecHitsES'),
                                                productLabels = cms.vstring( 'EcalRecHitsEB','EcalRecHitsEE','EcalRecHitsES'),
...
process.hltRechitInRegionsECALESWithJet = process.hltRechitInRegionsECALESStd.clone()
process.hltRechitInRegionsECALESWithJet.l1InputRegions.append(  cms.PSet(
...
process.recHitCompStd = cms.EDAnalyzer("EcalRecHitCollComparer",
                                     treeName=cms.string("recHitCompStdTree"),
                                     verbose=cms.int32(1),
                                     datasetCode=cms.int32(datasetCode),
                                     collection1=cms.VInputTag("hltRechitInRegionsECALESStd:EcalRecHitsEB",
                                                               "hltRechitInRegionsECALESStd:EcalRecHitsEE",
                                                               "hltRechitInRegionsECALESStd:EcalRecHitsES"),
                                     collection2=cms.VInputTag("hltRechitInRegionsECAL:EcalRecHitsEB",
                                                              "hltRechitInRegionsECAL:EcalRecHitsEE",
                                                              "hltRechitInRegionsES:EcalRecHitsES")
                                     )

process.recHitCompJet = cms.EDAnalyzer("EcalRecHitCollComparer",
                                     treeName=cms.string("recHitCompJetTree"),
                                     verbose=cms.int32(0),
                                     datasetCode=cms.int32(datasetCode),
                                     collection1=cms.VInputTag("hltRechitInRegionsECALESWithJet:EcalRecHitsEB",
                                                               "hltRechitInRegionsECALESWithJet:EcalRecHitsEE",
                                                               "hltRechitInRegionsECALESWithJet:EcalRecHitsES"),
                                     collection2=cms.VInputTag("hltRechitInRegionsECAL:EcalRecHitsEB",
                                                              "hltRechitInRegionsECAL:EcalRecHitsEE",
                                                              "hltRechitInRegionsES:EcalRecHitsES")
                                     )

process.recHitCompStdPath = cms.Path( process.HLTBeginSequence*process.HLTDoFullUnpackingEgammaEcalSequence* process.hltRechitInRegionsECAL *process.hltRechitInRegionsES* process.hltRechitInRegionsECALESStd * process.recHitCompStd )
process.recHitCompJetPath = cms.Path( process.HLTBeginSequence *process.HLTDoFullUnpackingEgammaEcalSequence* process.hltRechitInRegionsECAL *process.hltRechitInRegionsES* process.hltRechitInRegionsECALESWithJet * process.recHitCompJet )
...
process.MessageLogger.suppressError.append("simCaloStage1Digis")
from Configuration.AlCa.GlobalTag_condDBv2 import GlobalTag as customiseGlobalTag
