...
# set up process
process = cms.Process("TrigFilter2")
...
process.skimHLTFilter.HLTPaths = cms.vstring("HLT_Physics_v*")
...
process.load("SHarper.TrigTools.simTrigFilter_cfi")
process.simTrigFilter.trigEventTag = cms.InputTag("hltTriggerSummaryAOD","","HLT")
process.simTrigFilter.trigCuts = cms.vstring(
                                             "hltL1sL1SingleMu20:0:1",#"hltL1sMu16Eta2p1:0:1",
    )


process.skimP = cms.Path(process.skimHLTFilter*process.simTrigFilter)    
