...
#print "skimID: NrVertSkim"
print "skimID: DiHEEPSkimV2"
...
process.skimHLTFilter.HLTPaths = cms.vstring("HLT_Photon75_CaloIdVL_v*","HLT_Photon90_CaloIdVL_v*","HLT_Photon135_v*","HLT_Photon150_v*")
...
process.singlePhoFilter = cms.EDFilter("EventListSkimmer",
                                   ...
                                   #    filename = cms.string("SHarper/TrigTools/data/nrVert33SkimRunLumiEventSorted.list")
                                        filename = cms.string("SHarper/TrigTools/data/gsfTrkEffSkimSorted.list")
                                       )
