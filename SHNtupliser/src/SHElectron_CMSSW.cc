...
hademDepth1_(ele.hcalOverEcal(1)), 
hademDepth2_(ele.hcalOverEcal(2)),
...
isolHadDepth1DR04_(ele.dr04HcalTowerSumEt(1)),
isolHadDepth2DR04_(ele.dr04HcalTowerSumEt(2)),
...
isolEcalCluster_(ele.pfIsolationVariables().sumEcalClusterEt),
isolHcalCluster_(ele.pfIsolationVariables().sumHcalClusterEt),
hademDepth1BC_(ele.hcalOverEcalBc(1)),
hademDepth2BC_(ele.hcalOverEcalBc(2)),
isolHadDepth1BC_(ele.dr03HcalTowerSumEtBc(1)),
isolHadDepth2BC_(ele.dr03HcalTowerSumEtBc(2)),
...
hademDepth1_(pho.hadronicOverEm(1)), 
hademDepth2_(pho.hadronicOverEm(2)),
dEtaIn_(999.),
dEtaOut_(999.),
dPhiIn_(999.),
dPhiOut_(999.),
...
isolHadDepth1_(pho.hcalTowerSumEtConeDR03(1)),
isolHadDepth2_(pho.hcalTowerSumEtConeDR03(2)),
...
isolHadDepth1DR04_(pho.hcalTowerSumEtConeDR04(1)),
isolHadDepth2DR04_(pho.hcalTowerSumEtConeDR04(2)),
...
isolEcalCluster_(pho.ecalPFClusterIso()),
isolHcalCluster_(pho.hcalPFClusterIso()),
hademDepth1BC_(pho.hadTowOverEm(1)),
hademDepth2BC_(pho.hadTowOverEm(2)),
