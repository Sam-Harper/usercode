# /users/sharper/2017/egamma/skimmingMenu92X/V9 (CMSSW_9_2_2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/sharper/2017/egamma/skimmingMenu92X/V9')
)
...
process.hltPrePhoton27LooseSS = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPho27LooseSSClusterShapeFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    thrOverE2EE = cms.vdouble( -1.0 ),
    effectiveAreas = cms.vdouble( 0.0, 0.0 ),
    energyLowEdges = cms.vdouble( 0.0 ),
    doRhoCorrection = cms.bool( False ),
    saveTags = cms.bool( True ),
    thrOverE2EB = cms.vdouble( -1.0 ),
    thrRegularEE = cms.vdouble( 0.034 ),
    thrOverEEE = cms.vdouble( -1.0 ),
    varTag = cms.InputTag( 'hltEgammaClusterShape','sigmaIEtaIEta5x5' ),
    thrOverEEB = cms.vdouble( -1.0 ),
...
process.hltPho27LooseSSHEFilter = cms.EDFilter( "HLTEgammaGenericQuadraticEtaFilter",
    saveTags = cms.bool( True ),
    ...
    candTag = cms.InputTag( "hltPho27LooseSSClusterShapeFilter" ),
...
process.hltPreEle23Ele12CaloIdLTrackIdLIsoVLNoPM = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreEle27WPTight0NoPMGsf = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltEle27WPTight0ClusterShapeFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    thrOverE2EE = cms.vdouble( -1.0 ),
    effectiveAreas = cms.vdouble( 0.0, 0.0 ),
    energyLowEdges = cms.vdouble( 0.0 ),
    doRhoCorrection = cms.bool( False ),
    saveTags = cms.bool( True ),
    thrOverE2EB = cms.vdouble( -1.0 ),
    thrRegularEE = cms.vdouble( 0.029 ),
    thrOverEEE = cms.vdouble( -1.0 ),
    varTag = cms.InputTag( 'hltEgammaClusterShape','sigmaIEtaIEta5x5' ),
    thrOverEEB = cms.vdouble( -1.0 ),
...
process.hltEle27WPTight0HEFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    thrOverE2EE = cms.vdouble( -1.0 ),
    effectiveAreas = cms.vdouble( 0.082, 0.132, 0.306, 0.383 ),
    energyLowEdges = cms.vdouble( 0.0 ),
    doRhoCorrection = cms.bool( True ),
    saveTags = cms.bool( False ),
    thrOverE2EB = cms.vdouble( -1.0 ),
    thrRegularEE = cms.vdouble( -1.0 ),
    thrOverEEE = cms.vdouble( 0.02 ),
    varTag = cms.InputTag( "hltEgammaHoverE" ),
    thrOverEEB = cms.vdouble( 0.025 ),
    thrRegularEB = cms.vdouble( -1.0 ),
    lessThan = cms.bool( True ),
    l1EGCand = cms.InputTag( "hltEgammaCandidates" ),
    ncandcut = cms.int32( 1 ),
    absEtaLowEdges = cms.vdouble( 0.0, 1.0, 1.479, 2.1 ),
    candTag = cms.InputTag( "hltEle27WPTight0ClusterShapeFilter" ),
    rhoTag = cms.InputTag( "hltFixedGridRhoFastjetAllCaloForMuons" ),
    rhoMax = cms.double( 9.9999999E7 ),
    useEt = cms.bool( False ),
    rhoScale = cms.double( 1.0 )
)
process.hltEle27WPTight0EcalIsoFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    thrOverE2EE = cms.vdouble( -1.0 ),
    effectiveAreas = cms.vdouble( 0.302, 0.25, 0.252, 0.402 ),
    energyLowEdges = cms.vdouble( 0.0 ),
    doRhoCorrection = cms.bool( True ),
    saveTags = cms.bool( True ),
    thrOverE2EB = cms.vdouble( -1.0 ),
    ...
    ncandcut = cms.int32( 1 ),
    absEtaLowEdges = cms.vdouble( 0.0, 1.0, 1.479, 2.1 ),
    candTag = cms.InputTag( "hltEle27WPTight0HEFilter" ),
    rhoTag = cms.InputTag( "hltFixedGridRhoFastjetAllCaloForMuons" ),
    rhoMax = cms.double( 9.9999999E7 ),
    useEt = cms.bool( True ),
    rhoScale = cms.double( 1.0 )
)
process.hltEle27WPTight0HcalIsoFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    thrOverE2EE = cms.vdouble( -1.0 ),
    effectiveAreas = cms.vdouble( 0.213, 0.273, 0.361, 0.426 ),
    energyLowEdges = cms.vdouble( 0.0 ),
    doRhoCorrection = cms.bool( True ),
    saveTags = cms.bool( True ),
    thrOverE2EB = cms.vdouble( -1.0 ),
    thrRegularEE = cms.vdouble( -1.0 ),
    thrOverEEE = cms.vdouble( 0.03 ),
    varTag = cms.InputTag( "hltEgammaHcalPFClusterIso" ),
    ...
    ncandcut = cms.int32( 1 ),
    absEtaLowEdges = cms.vdouble( 0.0, 1.0, 1.479, 2.1 ),
    candTag = cms.InputTag( "hltEle27WPTight0EcalIsoFilter" ),
    rhoTag = cms.InputTag( "hltFixedGridRhoFastjetAllCaloForMuons" ),
    rhoMax = cms.double( 9.9999999E7 ),
    useEt = cms.bool( True ),
    rhoScale = cms.double( 1.0 )
)
process.hltPreEle27WPTight1NoPMGsf = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltEle27WPTight1ClusterShapeFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    thrOverE2EE = cms.vdouble( -1.0 ),
    effectiveAreas = cms.vdouble( 0.0, 0.0 ),
    energyLowEdges = cms.vdouble( 0.0 ),
    doRhoCorrection = cms.bool( False ),
...
process.hltEle27WPTight1HEFilter = cms.EDFilter( "HLTEgammaGenericQuadraticEtaFilter",
    saveTags = cms.bool( True ),
    effectiveAreas = cms.vdouble( 0.098, 0.159, 0.353, 0.423 ),
    ...
    thrRegularEB1 = cms.vdouble( 0.887 ),
    thrRegularEB2 = cms.vdouble( 1.476 ),
    candTag = cms.InputTag( "hltEle27WPTight1ClusterShapeFilter" ),
    thrOverE2EE1 = cms.vdouble( 0.0 ),
    thrOverE2EE2 = cms.vdouble( 0.0 ),
    rhoTag = cms.InputTag( "hltFixedGridRhoFastjetAllCaloForMuons" ),
    useEt = cms.bool( False ),
...
process.hltEle27WPTight1EcalIsoFilter = cms.EDFilter( "HLTEgammaGenericQuadraticEtaFilter",
    saveTags = cms.bool( True ),
    ...
    candTag = cms.InputTag( "hltEle27WPTight1HEFilter" ),
    thrOverE2EE1 = cms.vdouble( 0.0 ),
    thrOverE2EE2 = cms.vdouble( 0.0 ),
    rhoTag = cms.InputTag( "hltFixedGridRhoFastjetAllCaloForMuons" ),
    useEt = cms.bool( True ),
...
process.hltEle27WPTight1HcalIsoFilter = cms.EDFilter( "HLTEgammaGenericQuadraticEtaFilter",
    saveTags = cms.bool( True ),
    ...
    candTag = cms.InputTag( "hltEle27WPTight1EcalIsoFilter" ),
    thrOverE2EE1 = cms.vdouble( 0.0 ),
    thrOverE2EE2 = cms.vdouble( 0.0 ),
    rhoTag = cms.InputTag( "hltFixedGridRhoFastjetAllCaloForMuons" ),
    useEt = cms.bool( True ),
...
process.hltPreEle27WPLoose1PMGsf = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltEle27WPLoose1ClusterShapeFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    thrOverE2EE = cms.vdouble( -1.0 ),
    effectiveAreas = cms.vdouble( 0.0, 0.0 ),
    energyLowEdges = cms.vdouble( 0.0 ),
    doRhoCorrection = cms.bool( False ),
...
process.hltEle27WPLoose1HEFilter = cms.EDFilter( "HLTEgammaGenericQuadraticEtaFilter",
    saveTags = cms.bool( True ),
    effectiveAreas = cms.vdouble( 0.098, 0.159, 0.353, 0.423 ),
    ...
    thrRegularEB1 = cms.vdouble( 0.887 ),
    thrRegularEB2 = cms.vdouble( 1.476 ),
    candTag = cms.InputTag( "hltEle27WPLoose1ClusterShapeFilter" ),
    thrOverE2EE1 = cms.vdouble( 0.0 ),
    thrOverE2EE2 = cms.vdouble( 0.0 ),
    rhoTag = cms.InputTag( "hltFixedGridRhoFastjetAllCaloForMuons" ),
    useEt = cms.bool( False ),
...
process.hltEle27WPLoose1EcalIsoFilter = cms.EDFilter( "HLTEgammaGenericQuadraticEtaFilter",
    saveTags = cms.bool( True ),
    effectiveAreas = cms.vdouble( 0.325, 0.296, 0.283, 0.438 ),
    ...
    thrRegularEB1 = cms.vdouble( -0.581 ),
    thrRegularEB2 = cms.vdouble( -0.698 ),
    candTag = cms.InputTag( "hltEle27WPLoose1HEFilter" ),
    thrOverE2EE1 = cms.vdouble( 0.0 ),
    thrOverE2EE2 = cms.vdouble( 0.0 ),
    rhoTag = cms.InputTag( "hltFixedGridRhoFastjetAllCaloForMuons" ),
    useEt = cms.bool( True ),
...
process.hltEle27WPLoose1HcalIsoFilter = cms.EDFilter( "HLTEgammaGenericQuadraticEtaFilter",
    saveTags = cms.bool( True ),
    effectiveAreas = cms.vdouble( 0.259, 0.328, 0.414, 0.456 ),
    thrOverEEB1 = cms.vdouble( 0.035 ),
    varTag = cms.InputTag( "hltEgammaHcalPFClusterIso" ),
    ...
    thrRegularEB1 = cms.vdouble( 0.786 ),
    thrRegularEB2 = cms.vdouble( 0.298 ),
    candTag = cms.InputTag( "hltEle27WPLoose1EcalIsoFilter" ),
    thrOverE2EE1 = cms.vdouble( 0.0 ),
    thrOverE2EE2 = cms.vdouble( 0.0 ),
    rhoTag = cms.InputTag( "hltFixedGridRhoFastjetAllCaloForMuons" ),
    useEt = cms.bool( True ),
...
process.HLTPho27LooseSSSequence = cms.Sequence( process.HLTDoFullUnpackingEgammaEcalSequence + process.HLTPFClusteringForEgamma + process.hltEgammaCandidates + process.hltEGL1SingleEGOrFilter + process.hltEG27L1SingleEGOrEtFilter + process.hltEgammaClusterShape + process.hltPho27LooseSSClusterShapeFilter + process.HLTDoLocalHcalWithTowerL1EGSeededSequence + process.HLTFastJetForEgamma + process.hltEgammaHoverE + process.hltPho27LooseSSHEFilter )
...
process.HLTEle27WPTight0GsfSequence = cms.Sequence( process.HLTDoFullUnpackingEgammaEcalSequence + process.HLTPFClusteringForEgamma + process.hltEgammaCandidates + process.hltEGL1SingleEGOrFilter + process.hltEG27L1SingleEGOrEtFilter + process.hltEgammaClusterShape + process.hltEle27WPTight0ClusterShapeFilter + process.HLTDoLocalHcalWithTowerL1EGSeededSequence + process.HLTFastJetForEgamma + process.hltEgammaHoverE + process.hltEle27WPTight0HEFilter + process.hltEgammaEcalPFClusterIso + process.hltEle27WPTight0EcalIsoFilter + process.HLTPFHcalClusteringForEgamma + process.hltEgammaHcalPFClusterIso + process.hltEle27WPTight0HcalIsoFilter )
process.HLTEle27WPTight1GsfSequence = cms.Sequence( process.HLTDoFullUnpackingEgammaEcalSequence + process.HLTPFClusteringForEgamma + process.hltEgammaCandidates + process.hltEGL1SingleEGOrFilter + process.hltEG27L1SingleEGOrEtFilter + process.hltEgammaClusterShape + process.hltEle27WPTight1ClusterShapeFilter + process.HLTDoLocalHcalWithTowerL1EGSeededSequence + process.HLTFastJetForEgamma + process.hltEgammaHoverE + process.hltEle27WPTight1HEFilter + process.hltEgammaEcalPFClusterIso + process.hltEle27WPTight1EcalIsoFilter + process.HLTPFHcalClusteringForEgamma + process.hltEgammaHcalPFClusterIso + process.hltEle27WPTight1HcalIsoFilter )
process.HLTEle27WPLoose1GsfSequence = cms.Sequence( process.HLTDoFullUnpackingEgammaEcalSequence + process.HLTPFClusteringForEgamma + process.hltEgammaCandidates + process.hltEGL1SingleEGOrFilter + process.hltEG27L1SingleEGOrEtFilter + process.hltEgammaClusterShape + process.hltEle27WPLoose1ClusterShapeFilter + process.HLTDoLocalHcalWithTowerL1EGSeededSequence + process.HLTFastJetForEgamma + process.hltEgammaHoverE + process.hltEle27WPLoose1HEFilter + process.hltEgammaEcalPFClusterIso + process.hltEle27WPLoose1EcalIsoFilter + process.HLTPFHcalClusteringForEgamma + process.hltEgammaHcalPFClusterIso + process.hltEle27WPLoose1HcalIsoFilter )
...
process.HLT_Photon27_LooseSS_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEGor + process.hltPrePhoton27LooseSS + process.HLTPho27LooseSSSequence + process.HLTEndSequence )
process.HLT_Photon50_v8 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG34IorSingleEG40 + process.hltPrePhoton50 + process.HLTPhoton50Sequence + process.HLTEndSequence )
process.HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_NoPM_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleAndDoubleEGor + process.hltPreEle23Ele12CaloIdLTrackIdLIsoVLNoPM + process.HLTEle23Ele12CaloIdLCaloIsoSequence + process.HLTEndSequence )
...
process.HLT_Ele27_WPTight_0_NoPM_Gsf_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEGor + process.hltPreEle27WPTight0NoPMGsf + process.HLTEle27WPTight0GsfSequence + process.HLTEndSequence )
process.HLT_Ele27_WPTight_1_NoPM_Gsf_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEGor + process.hltPreEle27WPTight1NoPMGsf + process.HLTEle27WPTight1GsfSequence + process.HLTEndSequence )
process.HLT_Ele27_WPLoose_1_PM_Gsf_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEGor + process.hltPreEle27WPLoose1PMGsf + process.HLTEle27WPLoose1GsfSequence + process.HLTEndSequence )
...
process.nrEventsStorerPostPUL1Filter = cms.EDProducer("NrInputEventsStorer")
process.HLT_RemovePileUpDominatedEvents_v1 = cms.Path( 
        process.HLTBeginSequence + process.RemovePileUpDominatedEvents + process.nrEventsStorerPostPUL1Filter + process.HLTEndSequence 
        )


process.nrEventsStorerPostPUBothFilter = cms.EDProducer("NrInputEventsStorer")
process.HLT_RemovePileUpDominatedEventsBoth_v1 = cms.Path(  process.HLTBeginSequence +  process.RemovePileUpDominatedEventsGen + process.RemovePileUpDominatedEvents + process.nrEventsStorerPostPUBothFilter + process.HLTEndSequence)
...
process.nrEventsStorerPostEMFilter = cms.EDProducer("NrInputEventsStorer")
process.nrEventsStorerPostEMPUFilter = cms.EDProducer("NrInputEventsStorer")
process.HLT_EmGlobalFilter_v1 = cms.Path(process.HLTBeginSequence + process.genParticlesForFilter + ~process.bctoefilter + process.emenrichingfilter +process.nrEventsStorerPostEMFilter+ process.HLTEndSequence)
process.HLT_EmGlobalAndPUFilter_v1 = cms.Path(process.HLTBeginSequence +  process.RemovePileUpDominatedEventsGen + process.genParticlesForFilter + ~process.bctoefilter + process.emenrichingfilter +process.nrEventsStorerPostEMPUFilter+ process.HLTEndSequence)

process.nrEventsStorerPostEMPUBothFilter = cms.EDProducer("NrInputEventsStorer")
process.HLT_EmGlobalAndPUBothFilter_v1 = cms.Path(process.HLTBeginSequence +  process.RemovePileUpDominatedEventsGen + process.RemovePileUpDominatedEvents + process.genParticlesForFilter + ~process.bctoefilter + process.emenrichingfilter +process.nrEventsStorerPostEMPUBothFilter+ process.HLTEndSequence)
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Ele27_WPTight_Gsf_NoPM_v1, process.HLT_Photon27_LooseSS_v1, process.HLT_Photon50_v8, process.HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_NoPM_v1, process.HLT_DoublePhoton33_CaloIdL_v1, process.HLT_Ele27_WPTight_0_NoPM_Gsf_v1, process.HLT_Ele27_WPTight_1_NoPM_Gsf_v1, process.HLT_Ele27_WPLoose_1_PM_Gsf_v1, process.HLT_RemovePileUpDominatedEventsGen_v1, process.HLT_RemovePileUpDominatedEvents_v1,process.HLT_RemovePileUpDominatedEventsBoth_v1, process.HLT_EmGlobalFilter_v1 ,process.HLT_EmGlobalAndPUFilter_v1,process.HLT_EmGlobalAndPUBothFilter_v1,process.HLTriggerFinalPath, process.HLTAnalyzerEndpath ))
...
#process.hltOutputTot.SelectEvents.SelectEvents = cms.vstring("HLT_Ele27_WPTight_Gsf_NoPM_v1","HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_NoPM_v1","HLT_DoublePhoton33_CaloIdL_v1","HLT_Photon50_v8","HLT_Photon27_v1")
...
process.hltOutputTot.SelectEvents.SelectEvents = cms.vstring("HLT_Ele27_WPTight_Gsf_NoPM_v1","HLT_Photon27_LooseSS_v1","HLT_Photon50_v8","HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_NoPM_v1","HLT_DoublePhoton33_CaloIdL_v1","HLT_Ele27_WPTight_0_NoPM_Gsf_v1","HLT_Ele27_WPTight_1_NoPM_Gsf_v1","HLT_Ele27_WPLoose_1_PM_Gsf_v1")
