# /users/sharper/2017/egamma/initial2017RECO/initialEGPaths910/V8 (CMSSW_9_1_0_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/sharper/2017/egamma/initial2017RECO/initialEGPaths910/V8')
)
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = '92X_upgrade2017_TSG_For83XSamples_V3', conditions = 'L1Menu_Collisions2017_dev_r5_m4_patch_xml,L1TUtmTriggerMenuRcd,frontier://FrontierProd/CMS_CONDITIONS,,9999-12-31 23:59:59.000')
