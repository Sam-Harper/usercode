# /users/sharper/2017/egamma/pmTest/newPMOnSkim/V7 (CMSSW_9_0_0_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/sharper/2017/egamma/pmTest/newPMOnSkim/V7')
)
