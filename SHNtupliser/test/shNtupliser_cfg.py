...
process.shNtupliser.minEtToPassEvent = cms.double(7.)
process.shNtupliser.outputGeom = cms.bool(False)
process.shNtupliser.useHLTDebug = cms.bool(True)
process.shNtupliser.hltProcName = "EWK"
process.shNtupliser.trigResultsTag = cms.InputTag("TriggerResults","","EWK")
