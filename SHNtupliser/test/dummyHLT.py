# /users/sharper/2017/egamma/pmTest/newPMMenu/V8 (CMSSW_9_0_0_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/sharper/2017/egamma/pmTest/newPMMenu/V8')
)
...
#process.HLT_DoubleEle33_CaloIdL = cms.Path( process.HLTBeginSequence + process.hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau + process.hltPreDoubleEle33CaloIdL + process.HLTEle33CaloIdLSequence + process.HLTDoubleEle33CaloIdLUnseededSequence + process.HLTEndSequence )
process.HLTriggerFinalPath = cms.Path( process.hltGtStage2Digis + process.hltScalersRawToDigi + process.hltFEDSelector + process.hltTriggerSummaryAOD + process.hltTriggerSummaryRAW + process.hltBoolFalse )


process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Ele5_CaloIdL_GsfTrkIdVL_v6 , process.HLTriggerFinalPath ))
...
if 'hltPreExpressCosmicsOutputSmart' in process.__dict__:
    process.hltPreExpressCosmicsOutputSmart.hltResults = cms.InputTag( 'TriggerResults', '', 'HLT' )

if 'hltPreExpressOutputSmart' in process.__dict__:
    process.hltPreExpressOutputSmart.hltResults        = cms.InputTag( 'TriggerResults', '', 'HLT' )

if 'hltPreDQMForHIOutputSmart' in process.__dict__:
    process.hltPreDQMForHIOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'HLT' )

if 'hltPreDQMForPPOutputSmart' in process.__dict__:
    process.hltPreDQMForPPOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'HLT' )

if 'hltPreHLTDQMResultsOutputSmart' in process.__dict__:
    process.hltPreHLTDQMResultsOutputSmart.hltResults  = cms.InputTag( 'TriggerResults', '', 'HLT' )

if 'hltPreHLTDQMOutputSmart' in process.__dict__:
    process.hltPreHLTDQMOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'HLT' )

if 'hltPreHLTMONOutputSmart' in process.__dict__:
    process.hltPreHLTMONOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'HLT' )
...
_customInfo['inputFile' ]=  ['file:/opt/ppd/month/harper/mc/9_0_2/SingleElePt1To100_GENSIMRAW/SingleElePt1To100_GENSIMRAW_1.root']#/store/mc/PhaseIFall16DR/ZToEE_NNPDF30_13TeV-powheg_M_50_120/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_EXO40_90X_upgrade2017_realistic_v6_C1-v1/80000/002BF7E7-9710-E711-A183-5065F38122A1.root']
...
process.hltOutputTot.outputCommands = process.RAWSIMEventContent.outputCommands
process.hltOutputTot.outputCommands.append("keep *_mix_*_*")
process.hltOutputTot.outputCommands = process.FEVTDEBUGHLTEventContent.outputCommands
