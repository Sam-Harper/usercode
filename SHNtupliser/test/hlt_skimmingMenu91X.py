# /users/sharper/2017/egamma/skimmingMenu91X/V7 (CMSSW_9_1_0_pre3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/sharper/2017/egamma/skimmingMenu91X/V7')
)
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Ele27_WPTight_Gsf_NoPM_v1, process.HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_NoPM_v1, process.HLT_DoublePhoton33_CaloIdL_v1,process.HLT_RemovePileUpDominatedEventsGen_v1, process.HLT_EmGlobalAndPUFilter_v1, process.HLTriggerFinalPath, process.HLTAnalyzerEndpath ))
...
process.MessageLogger.categories.append("addTracoT")
process.MessageLogger.cerr.addTracoT=cms.untracked.PSet(limit=cms.untracked.int32(1))
...
process.hltOutputTot.SelectEvents.SelectEvents = cms.vstring("HLT_Ele27_WPTight_Gsf_NoPM_v1","HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_NoPM_v1","HLT_DoublePhoton33_CaloIdL_v1")
