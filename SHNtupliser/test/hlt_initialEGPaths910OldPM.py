# /users/sharper/2017/egamma/test/initialEGPaths910OldPM/V3 (CMSSW_9_1_0_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/sharper/2017/egamma/test/initialEGPaths910OldPM/V3')
)
...
process.HLTElePixelMatchSequence = cms.Sequence( process.HLTDoLocalPixelSequence + process.HLTDoLocalStripSequence + process.hltPixelLayerPairsEgamma + process.hltMixedLayerPairs + process.hltEgammaElectronPixelSeeds + process.hltEgammaPixelMatchVars )
...
process.HLTElePixelMatchUnseededSequence = cms.Sequence( process.HLTDoLocalPixelSequence + process.HLTDoLocalStripSequence + process.hltPixelLayerPairsEgamma + process.hltMixedLayerPairs + process.hltEgammaElectronPixelSeedsUnseeded + process.hltEgammaPixelMatchVarsUnseeded )
...
useInitConditions=False
if useInitConditions:
    print "startup pixel conditions"
    process.GlobalTag.toGet.append(
        cms.PSet(
            connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
            record = cms.string("TrackerAlignmentRcd"),
            tag = cms.string("TrackerAlignment_Phase1Realignment_CRUZET_2M_v1")
            ),
        )
    process.GlobalTag.toGet.append(
        cms.PSet(
            ...
            tag = cms.string("TrackerAlignmentExtendedErrors_BPIX50_FPIX50_TIB20_TOB20_TID40_TEC40")), #error scenario 1
        #tag = cms.string("TrackerAlignmentExtendedErrors_BPIX100_FPIX100_TIB20_TOB20_TID40_TEC40")), #error scenario 2
        )
...
process.hltEgammaElectronPixelSeeds.SeedConfiguration.OrderedHitsFactoryPSet.SeedingLayers = cms.InputTag( "hltMixedLayerPairs" )
process.hltEgammaElectronPixelSeedsUnseeded.SeedConfiguration.OrderedHitsFactoryPSet.SeedingLayers = cms.InputTag( "hltMixedLayerPairs" )
