...
shNtupPara = cms.PSet(
    ...
    hltIsoEleProducer = cms.InputTag(""),
    hltNonIsoEleProducer = cms.InputTag(""),
    hltIsoEcalCandProducer = cms.InputTag("hltEgammaCandidatesUnseeded"),
    hltNonIsoEcalCandProducer = cms.InputTag(""),
    
    ecalCandValuesToSave = cms.vstring("clusShape:hltEgammaClusterShapeUnseeded@sigmaIEtaIEta5x5:dummy",
                                     "hadem:hltEgammaHoverEUnseeded:dummy",
                                     "dPhiIn:hltEgammaGsfTrackVarsUnseeded@Dphi:dummy",
                                     "dEtaIn:hltEgammaGsfTrackVarsUnseeded@Deta:dummy"),                      
    eleValuesToSave = cms.vstring(),
