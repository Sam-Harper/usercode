...
process.heepVIDFilter = cms.EDAnalyzer("HEEPGsfEleVIDFilter",
                                       src=cms.InputTag("gedGsfElectrons"),
                                       vid=cms.InputTag("egmGsfElectronIDs:heepElectronID-HEEPV70"),
                                       minNrRequired=cms.int32(2)
...
process.p = cms.Path(
    ...
    process.heepVIDFilter) #our analysing example module, replace with your module
