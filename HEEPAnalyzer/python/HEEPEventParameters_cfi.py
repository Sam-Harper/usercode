...
heepEventPara  = cms.PSet (
    ...
    barrelWeightsRecHitTag = cms.InputTag("ecalWeightsRecHit","EcalRecHitsEB"),
    endcapWeightsRecHitTag = cms.InputTag("ecalWeightsRecHit","EcalRecHitsEE"),
    ...
    patTrigObjsTag=cms.InputTag("selectedPatTrigger"),
