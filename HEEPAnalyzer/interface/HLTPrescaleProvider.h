...
#ifndef SHARPER_HEEPANALYZER_HLTPRESCALEPROVIDER_HH
#define SHARPER_HEEPANALYZER_HLTPRESCALEPROVIDER_HH

//a class which tries to emulate HLTPrescaleProvider in 74X, do not use in 76X!
