#ifndef SHARPER_HEEPANALYZER_HEEPElectronTkIsolation_h
#define SHARPER_HEEPANALYZER_HEEPElectronTkIsolation_h
//*****************************************************************************
...
//This is a complete copy of RecoEgamma/EgammaIsolationAlgo with modifications 
//to calculate the HEEP isolation without the jetCoreRegional step
//Its done here as an alternative to patching the official file 
//which means lots of packages need to be rebuilt
