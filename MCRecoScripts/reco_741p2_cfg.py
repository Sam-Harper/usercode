...
# with command line options: step2 --fileout reco.root --mc --eventcontent AODSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --conditions MCRUN2_74_V9 --step RAW2DIGI,L1Reco,RECO,EI --magField 38T_PostLS1 --python_filename reco_741p2_cfg.py --no_exec -n 82
